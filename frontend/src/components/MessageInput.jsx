...
const MessageInput = () => {
  ...
  return (
    <div className='p-4 w-full'>
      {imagePreview && (
        <div className='mb-3 flex items-center fap-2'>
      ...
      <form onSubmit={handleSendMessage} className='flex items-center gap-2'>
        ...
        <button type='submit' className='btn btn btn-circle' disabled={!text.trim() && !imagePreview}>
          <Send size={20} className='mr-0.85'/>
        </button>
